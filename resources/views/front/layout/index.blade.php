...
<head>
  ...
  <link rel="stylesheet" href="{{ url ('assets2/vendors/bootstrap/bootstrap.min.css') }}">
  <link rel="stylesheet" href="{{ url ('assets2/vendors/fontawesome/css/all.min.css') }}">
  <link rel="stylesheet" href="{{ url ('assets2/vendors/themify-icons/themify-icons.css') }}">
  <link rel="stylesheet" href="{{ url ('assets2/vendors/linericon/style.css') }}">
  <link rel="stylesheet" href="{{ url ('assets2/vendors/owl-carousel/owl.theme.default.min.css') }}">
  <link rel="stylesheet" href="{{ url ('assets2/vendors/owl-carousel/owl.carousel.min.css') }}">
  <link rel="stylesheet" href="{{ url ('assets2/vendors/flat-icon/font/flaticon.css') }}">
  <link rel="stylesheet" href="{{ url ('assets2/vendors/nice-select/nice-select.css') }}">
    ...
    <div class="main_menu">
      <nav class="navbar navbar-expand-lg navbar-light">
        <div class="container box_1620">
          <a class="navbar-brand logo_h" href="index.html"><img src="{{ url ('assets2/img/logo.png') }}" alt=""></a>
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p>
  ...
  <script src="vendors/nice-select/jquery.nice-sele